    ...
    <nav className="sticky top-0 z-20 bg-white/80 backdrop-blur border-b border-gray-100">
      <div className="max-w-7xl mx-auto px-4 py-3 grid grid-cols-12 gap-4 items-center">
        ...
        <div className="col-span-12 sm:col-span-3 flex justify-end items-center gap-5">
          <Link to="/restaurants" className="text-gray-700 hover:text-brand-600 hidden md:inline">Restaurants</Link>
          <Link to="/cart" className="relative inline-flex">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-6 h-6 text-gray-700 hover:text-brand-600">
          ...
          {user && (
            <div className="flex items-center gap-3">
              ...
              <Link to="/profile" className="w-8 h-8 rounded-full bg-gradient-to-br from-orange-200 to-orange-300 grid place-items-center text-gray-700">{user.name.charAt(0)}</Link>
