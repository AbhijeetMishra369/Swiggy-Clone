      ...
      <div className="container py-8 grid grid-cols-2 md:grid-cols-4 gap-6 text-sm text-gray-600 dark:text-gray-300">
        ...
        <div>
          ...
          <ul className="space-y-2">
            ...
            <li><a href="#" className="hover:text-gray-800 dark:hover:text-gray-200">Contact</a></li>
          </ul>
        </div>
        <div>
          <h4 className="font-semibold text-gray-900 dark:text-gray-100 mb-3">Legal</h4>
          <ul className="space-y-2">
            <li><a href="#" className="hover:text-gray-800 dark:hover:text-gray-200">Terms & Conditions</a></li>
            <li><a href="#" className="hover:text-gray-800 dark:hover:text-gray-200">Privacy Policy</a></li>
          </ul>
        </div>
        <div>
          <h4 className="font-semibold text-gray-900 dark:text-gray-100 mb-3">Follow</h4>
          <div className="flex items-center gap-3">
            <a href="#" aria-label="Twitter" className="hover:text-gray-800 dark:hover:text-gray-200">
            ...
            <a href="#" aria-label="Instagram" className="hover:text-gray-800 dark:hover:text-gray-200">
            ...
            <a href="#" aria-label="Facebook" className="hover:text-gray-800 dark:hover:text-gray-200">
